...
return packer.startup(function(use)
  ...
  -- use { "nvim-telescope/telescope-file-browser.nvim", commit="" }
  ...
  -- Trouble
  use { "folke/trouble.nvim", commit = "929315ea5f146f1ce0e784c76c943ece6f36d786", requires = "kyazdani42/nvim-web-devicons", }

  -- Twilight
  use { "folke/twilight.nvim", commit = "1ffa6a4d89fb2fbb784c6674044bf54f1fca936f", }

  -- WhichKey
  use { "folke/which-key.nvim", commit = "439637d6a75fe27e369190df7910ed2a454109f6" }
